...
r = requests.post(host_result, headers=headers, data={hidden_fields[0]: re.search('<input type=hidden name="SuppID" value="(.*)">', r.text).group(1), fields[0]: 'I don\'t think the value matters, am I right ?'})
