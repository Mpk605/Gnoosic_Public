    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            try (Response response = client.newCall(request).execute()) {
                ...
                return Objects.requireNonNull(((HashMap) Objects.requireNonNull(((HashMap) ((ArrayList) Objects.requireNonNull(result.get("items"))).get(0)).get("id"))).get("videoId")).toString();
            } catch (IOException e) {
                e.printStackTrace();
            }
