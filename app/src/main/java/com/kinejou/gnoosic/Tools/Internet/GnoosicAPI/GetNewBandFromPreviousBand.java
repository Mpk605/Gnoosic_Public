...
public class GetNewBandFromPreviousBand extends AsyncTask<String, Void, Integer> {
    private OkHttpClient client = new OkHttpClient();
    private String[] newBand;

    /**
     * Return new band based on the previous one
     *
     * @param strings 0: ['RateP01', 'RateN01', 'Rate00'], 1: SuppID
     * @return int result code
     */
    @Override
    protected Integer doInBackground(String... strings) {
        RequestBody body = new FormBody.Builder()
                .add("SuppID", strings[1])
                .add(strings[0], "Bring a little lovin'")
                .build();
